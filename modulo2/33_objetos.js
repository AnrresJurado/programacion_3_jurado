...
console.log(persona2.cumpleaños());   // "¡Feliz cumpleaños, Ana! Ahora tienes 29."
console.log(persona2.saludarArrow()); // "Hola, soy undefined"
...
const persona3 = { nombre, edad, ciudad };
