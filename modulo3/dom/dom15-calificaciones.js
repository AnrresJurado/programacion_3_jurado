...
function renderizarTabla() {
   ...
   alumnos.forEach((alumno, index) => {
       ...
       // Corrección: Asignar evento eliminar directamente en JS para evitar fallos de scope
...
// Asignación de eventos globales al cargar la página
window.onload = () => {
   // Detectar Enter en los campos de texto
   ...
   // Vincular funciones a tus botones principales (asegúrate de que estos IDs existan en tu HTML)
   const btnCalcular = document.getElementById('btnCalcular');
   if (btnCalcular) btnCalcular.addEventListener('click', calcularEstadisticas);
