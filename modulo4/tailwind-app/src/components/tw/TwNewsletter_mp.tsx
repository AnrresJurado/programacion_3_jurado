  ...
  return (
    <section className="border-t border-white/10 bg-slate-950 py-16">
      <div className="mx-auto max-w-5xl px-4 text-center">
        <h2 className="text-2xl font-extrabold text-white mb-2">Alertas de Vías y Estado de Carreteras (_mp)</h2>
        <p className="text-white/50 mb-8 max-w-md mx-auto">
          Suscríbete para recibir reportes de tráfico, cierres de vías y estado de peajes.
        </p>
        ...
        {success && (
          <div className="mb-6 inline-block rounded-2xl border border-emerald-400/30 bg-emerald-400/10 px-6 py-3 text-emerald-300 text-sm">
            ✅ Suscripción a alertas completada
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="flex justify-center gap-2 flex-wrap">
          <input
            ...
            placeholder="despacho@transporte.com"
            required
